...
9) Correaltion_gene_expression_and_RCTD_cell_types.R - This workflow calculates per-sample Pearson correlations between the abundance of each cell type and cytokine expression (IL1A, IL1B, IL17A, IL17F, IL23A) in spatial transcriptomics HS Visium data. It outputs correlation matrices for all cytokines across all samples and cell types to CSV, enabling downstream analysis of cellular-cytokine relationships.
